...
cfrac=0.173; %fraction of spacecraft surface that is painted white instead of gold coated
...
orbits=150; %number of orbits between mass dumps, for ease of editing
